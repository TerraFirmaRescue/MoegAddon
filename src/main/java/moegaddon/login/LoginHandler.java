...
public class LoginHandler {
    ...
    public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event)
    {
        ...
        event.player.addChatMessage(new ChatComponentText(EnumChatFormatting.BOLD +  "   " + MoegAddon.translate("text.login.0") + " " + EnumChatFormatting.AQUA + EnumChatFormatting.BOLD + CommonProxy.MOD_CONFIG.ModPackVersion));
        ...
        if (!CommonProxy.MOD_CONFIG.ModPackVersion.equalsIgnoreCase(CommonProxy.LATEST_MODPACK_VERSION)) {
