...
public class BLOCK_DifferentiationPromotingProteinNeuron extends BlockFluidClassic {
    ...
    public BLOCK_DifferentiationPromotingProteinNeuron(Fluid fluid, String blockName) {
