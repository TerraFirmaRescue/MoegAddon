...
public class FluidLoader {
    ...
    public static final Fluid AbsorptionLiquidRu = new FluidBase("AbsorptionLiquidRu");    //吸收液（富钌）
    public static final Fluid RutheniumTetroxide = new FluidBase("RutheniumTetroxide");    //四氧化钌
    public static final Fluid OsmiumTetroxide = new FluidBase("OsmiumTetroxide");    //四氧化锇
    public static final Fluid ChloroRhodiumAcid = new FluidBase("ChloroRhodiumAcid");    //氯钌酸
}
//湿件相关没有加
